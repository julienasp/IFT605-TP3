...
public class AgentSummativeEquation extends Agent{
	private static final long serialVersionUID = 5165180566339086201L;
	...
	protected void setup() {
		...
		OneShotBehaviour reception = new OneShotBehaviour(this) {
			...
			public void action() {
				...
				if(msg!=null){
					try {
						if(msg.getContentObject() instanceof SummativeEquation){
							SummativeEquation me = (SummativeEquation) msg.getContentObject();												
		...
		OneShotBehaviour derivation = new OneShotBehaviour(this) {
			private static final long serialVersionUID = 4984692560919402502L;

			protected Equation derivate(SummativeEquation me){
			...
			public void action() {
				...
				SummativeEquation me = (SummativeEquation) fsm.getDataStore().get(DERIVATION_REQUEST);
		...
		OneShotBehaviour renvoi = new OneShotBehaviour(this) {
			private static final long serialVersionUID = 981208612463153195L;
